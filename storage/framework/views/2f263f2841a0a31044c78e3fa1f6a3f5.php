 ...
 <div class="page-header">
     <div class="header-wrapper row m-0">
         ...
         <div class="header-logo-wrapper col-auto p-0">
             <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="s/logo/logo.png"
                         alt=""></a></div>
                                 ...
                                 <div class="col mega-box">
                                     <div class="link-section">
                                         ...
                                         <ul>
                                             ...
                                             <li class="ps-0"><a href="template-email-2.html">Email Template 2</a>
                                             </li>
                                             <li class="ps-0"><a href="ecommerce-templates.html">Ecommerce Email</a>
                                             </li>
                                             <li class="ps-0"><a href="email-order-success.html">Order Success</a>
                                             </li>
                                         </ul>
                                     </div>
                                 </div>
...
<?php /**PATH C:\xampp\htdocs\liveProject\wetransfer_group-project-main-2-zip_2025-01-15_1212\group-project-main (2)\group-project-main\resources\views/layouts/inc/admin/navbar.blade.php ENDPATH**/ ?>