<?php $__env->startSection('content'); ?>
    <div class="container mt-5">
        ...
        <form action="<?php echo e(isset($product) ? route('products.update', $product->id) : route('products.store')); ?>" method="POST"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="d-flex flex-wrap">
                                    <?php $__currentLoopData = json_decode($product->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img src="<?php echo e(asset('uploads/products/' . $image)); ?>" alt="Product Image"
            ...
            <button type="submit"
                class="btn btn-primary mb-3"><?php echo e(isset($product) ? 'Update Product' : 'Create Product'); ?></button>
        </form>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm\group-project-main\resources\views/admin/product/create.blade.php ENDPATH**/ ?>