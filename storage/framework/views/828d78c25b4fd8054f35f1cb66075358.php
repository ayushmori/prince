            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="">
                            <input type="checkbox" class="form-check-input me-2" id="cat-<?php echo e($cat->id); ?>" onclick="filterCategory('<?php echo e(url('/category', $cat->id)); ?>')">
                                ...
                                <div class="">
                                    <?php $__currentLoopData = $cat->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item">
                                            <input type="checkbox" class="form-check-input me-2" id="subcat-<?php echo e($subcat->id); ?>" onclick="filterCategory('<?php echo e(url('/subcategory', $subcat->id)); ?>')">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="">
                            <input type="checkbox" class="form-check-input me-2" id="brand-<?php echo e($brand->id); ?>" onclick="filterCategory('<?php echo e(url('/brand', $brand->id)); ?>')">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        ...
                                        <?php if(!empty($images) && is_array($images)): ?>
                                            <img src="<?php echo e(url($images[0])); ?>" alt="Product Image" class="card-img-top">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('images/placeholder.png')); ?>" alt="No Image" class="card-img-top">
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kaushik\project\group-project-main\resources\views/frontend/category/show.blade.php ENDPATH**/ ?>