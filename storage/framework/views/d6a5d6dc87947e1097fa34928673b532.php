 ...
 <div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="s/logo/logo.png" alt=""></a></div>
  ...
  </div><?php /**PATH C:\xampp\htdocs\group-porject\resources\views/layouts/inc/admin/navbar.blade.php ENDPATH**/ ?>