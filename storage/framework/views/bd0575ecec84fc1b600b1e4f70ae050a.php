 ...
 <div class="sidebar-wrapper">
    <div>
      <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?php echo e(asset('admin\images\logo\logo.png')); ?>" alt=""><img class="img-fluid for-dark" src="<?php echo e(asset('admin/logo/logo_dark.png')); ?>" alt=""></a>
        <div class="back-btn"><i class="fa fa-angle-left"></i></div>
        <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
      </div>
      <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo e(asset('admin/images/logo/logo-icon.png')); ?>" alt=""></a></div>
      <nav class="sidebar-main">
        <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            <li class="back-btn"><a href="#"><img class="img-fluid" src="<?php echo e(asset('admin/images/logo/logo-icon.png')); ?>" alt=""></a>
            ...
            <li class="sidebar-list">
              <a class="sidebar-link sidebar-title" href="<?php echo e(route('admin.dashboard')); ?>">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="airplay"></i><span>Main Slider</span></a>
              <ul class="sidebar-submenu">
                <li><a href="<?php echo e(url('admin/sliders/create' )); ?>">Add Main Slider</a></li>
                <li><a href="<?php echo e(url('admin/sliders' )); ?>">View Main Slider</a></li>
              </ul>
            </li>
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('admin.secondsliders.create')); ?>">Add Sigle Slider</a></li>
                    <li><a href="<?php echo e(route('admin.secondsliders.index')); ?>">View Sigle Sliders</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('admin.minisiders.create')); ?>">Add There Image Slider</a></li>
                    <li><a href="<?php echo e(route('admin.minisiders.index')); ?>">View There Image Slider</a></li>
                </ul>
            </li>
  ...
  <!-- Page Sidebar Ends-->
<?php /**PATH C:\xampp\htdocs\group-porject\resources\views/layouts/inc/admin/sidebar.blade.php ENDPATH**/ ?>