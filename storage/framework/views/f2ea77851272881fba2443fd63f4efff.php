            ...
            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sliderItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                    <?php if($sliderItem->image): ?>
                        <img src="<?php echo e(asset('/uploads/slider/' . $sliderItem->image)); ?>" class="d-block w-100" style="height: 600px; object-fit: cover;" alt="Image">
                    <?php endif; ?>
                </div>
...
<div class="container">
    ...
    <div class="categories-slider">
        <div class="categories-track">
            <?php $__currentLoopData = $category->chunk(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<style>
    ...
    <div class="container mt-2">
        <div class="row g-4">
            <?php $__currentLoopData = range(0, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Change the range to 0, 1 for two sliders -->
                <div class="col-12 col-md-6"> <!-- Adjusted col size to fit two sliders -->
                    <div class="mini-slider-container">
                        <div class="image-track">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <div class="slide-image">
                                <img src="<?php echo e(asset('uploads/mini-slider/' . $minislider[0]->image)); ?>" alt="Slider Image"
                                     class="mini-slider-image">
                            </div>
                        </div>
                    </div>
            ...
            containers.forEach((container, containerIndex) => {
                ...
                setInterval(() => {
                    ...
                    track.style.transform =
                        `translateX(-${currentPosition * (100 / (<?php echo e(count($minislider) + 1); ?>))}%)`;
