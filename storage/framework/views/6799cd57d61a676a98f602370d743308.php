...
<div class="card-header text-white">
  ...
  <div class="container my-5">
        <div class="row">
        <div class="col-md-3">
        <h1 class=""><?php echo e($category->name); ?></h1>
        <div class="card">
                        <div class="card-header">
                            <h5>Filters</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><input type="checkbox" id="filter1"> <label
                                            for="filter1"><?php echo e($product->name); ?></label></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
          ...
          <div class="col-md-3 mb-4">
              ...
              <?php endif; ?>
                  <div class="card-body">
                      ...
                      <p class="card-text">
                          <strong>Price:</strong>
                          <span class="text-danger">$<?php echo e(number_format($product->price, 2)); ?></span>
                        ...
                        <div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="documents-tab">
                            ...
                            <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card mb-4 mx-3">
                                    ...
                                    <div class="card-body">
                                        <?php $__empty_2 = true; $__currentLoopData = $product->mainDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                            <div class="card mb-3">
                                                <div class="card-body">
                                    ...
                                    <?php $__empty_2 = true; $__currentLoopData = $product->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <div class="card mb-3">
                                            <div class="card-body">
