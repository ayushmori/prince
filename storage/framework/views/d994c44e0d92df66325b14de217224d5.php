          ...
          <div class="row text-md-left">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 footer-section">
              ...
              <ul class="list-unstyled">
                ...
                <?php else: ?>
                <?php $__currentLoopData = $categories->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                  <a href="<?php echo e(url('/category/' . $categoryItem->slug)); ?>" class="text-white">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 footer-section">
              ...
              <ul class="list-unstyled">
                ...
                <?php else: ?>
                <?php $__currentLoopData = $brands->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                  <a href="<?php echo e(url('/brand/' . $brand->slug)); ?>" class="text-white">
...
<?php /**PATH D:\prince\prince-gpm\group-project-main\resources\views/layouts/inc/frontend/footer.blade.php ENDPATH**/ ?>