                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="serial_number"
                                    value="<?php echo e($category->serial_number); ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <?php if($category->image): ?>
                                    <img src="<?php echo e(asset('uploads/category/' . $category->image)); ?>" alt="Category Image"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\group-porject\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>