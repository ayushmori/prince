<?php $__env->startSection('content'); ?>
    <div class="container mt-5">
        ...
        <form action="<?php echo e(isset($product) ? route('products.update', $product->id) : route('products.store')); ?>" method="POST"
                    ...
                    <?php $__currentLoopData = $product->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="document mb-3" id="document-<?php echo e($index); ?>">
                            ...
                            <select name="documents[<?php echo e($index); ?>][type]" class="form-control" required>
                                <option value="Software" <?php echo e($document->type == 'Software' ? 'selected' : ''); ?>>Software</option>
                                <option value="PDF" <?php echo e($document->type == 'PDF' ? 'selected' : ''); ?>>PDF</option>
                                <option value="Driver" <?php echo e($document->type == 'Driver' ? 'selected' : ''); ?>>Driver</option>
                            </select>
                            ...
                            <?php if($document->file_path): ?>
                                <div class="mt-2">
                                    ...
                                    <a href="<?php echo e(asset('storage/' . $document->file_path)); ?>" target="_blank">View Document</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $product->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="card attribute-row mb-3">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Attribute <?php echo e($index + 1); ?></h5>
                                                        <input type="text"
                                                            name="attributes[<?php echo e($index); ?>][title]"
                                                            class="form-control mb-2" placeholder="Attribute Title"
                                                            required value="<?php echo e($attribute->title); ?>">
                                                        <textarea name="attributes[<?php echo e($index); ?>][description]" class="form-control mb-3"
                                                            placeholder="Attribute Description" required><?php echo e($attribute->description); ?></textarea>
                                                                ...
                                                                <div class="card attribute-row mb-3">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Attribute
                                                                            <?php echo e($index + 1); ?></h5>
                                                                        <input type="text"
                                                                            name="attributes[<?php echo e($index); ?>][title]"
                                                                            class="form-control mb-2"
                                                                            placeholder="Attribute Title" required
                                                                            value="<?php echo e($attribute->title); ?>">
                                                                        <textarea name="attributes[<?php echo e($index); ?>][description]" class="form-control mb-3"
                                                                            placeholder="Attribute Description" required><?php echo e($attribute->description); ?></textarea>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="col-md-5">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                value="<?php echo e($shortAttribute->key); ?>">
                                                                                        </div>
                                                                                        <div class="col-md-5">
                                                                                            <input type="text"
                                                                                                name="attributes[<?php echo e($index); ?>][short_attributes][<?php echo e($shortIndex); ?>][value]"
                                                                                                ...
                                                                                                placeholder="Value"
                                                                                                required
                                                                                                value="<?php echo e($shortAttribute->value); ?>">
                                                                                        </div>
                                                                                        <div class="col-md-2 text-end">
                                                                                            <button type="button"
                                                                                                class="btn btn-danger remove-short-attribute">Remove</button>
            ...
            <button type="submit"
                class="btn btn-primary mb-4"><?php echo e(isset($product) ? 'Update Product' : 'Create Product'); ?></button>
        </form>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prince\prince-gpm\group-project-main\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>