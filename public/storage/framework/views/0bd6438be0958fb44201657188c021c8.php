    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <h3>Add There Image Slider
                <a href="<?php echo e(url('admin/minisiders')); ?>" class="btn btn-danger btn-sm text-white float-end">Back</a>
            </h3>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Project - Laravel\group-project-main\resources\views/admin/minisiders/create.blade.php ENDPATH**/ ?>