    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Add Slider
              <a href="<?php echo e(url('admin/minisiders/create')); ?>" class="btn btn-danger btn-sm text-white float-end">Add</a>
          </h3>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Project - Laravel\group-project-main\resources\views/admin/minisiders/index.blade.php ENDPATH**/ ?>