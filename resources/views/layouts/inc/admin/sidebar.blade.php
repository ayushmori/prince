...
<div class="sidebar-wrapper">
    <div>
        ...
        <nav class="sidebar-main">
            ...
            <li class="sidebar-list">
                <a class="sidebar-link sidebar-title" href="#">
                    <i data-feather="layers"></i><span>three Image Slider</span>
                </a>
                <ul class="sidebar-submenu">
                    <li><a href="{{ route('admin.minisiders.create') }}">Add Three Image Slider</a></li>
                    <li><a href="{{ route('admin.minisiders.index') }}">View Three Image Slider</a></li>
                </ul>
            </li> --}}

                    {{-- <li class="sidebar-list">
                <a class="sidebar-link sidebar-title" href="#">
                    <i data-feather="layers"></i><span>All Slider</span>
                </a>
                <ul class="sidebar-submenu">
                    <li><a href="{{ url('admin/all-slider/create') }}">Add  Slider</a></li>
