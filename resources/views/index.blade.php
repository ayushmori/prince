...
<div class="container">
<h2 class="text-center m-4">Brand</h2>
<div id="imageCarousel" class="carousel slide mx-auto mt-5" data-bs-ride="carousel">
    <div class="carousel-inner">
        @php
            ...
            $slidesToShow = ceil($totalImages / 2); // Total slides (2 images per slide)
        @endphp
        ...
        @for ($i = 0; $i < $slidesToShow; $i++)
            <div class="carousel-item {{ $i === 0 ? 'active' : '' }}">
                <div class="container">
                    <div class="row">
                        @for ($j = 0; $j < 2; $j++) <!-- 2 images per slide -->
                            @php
                                // Calculate the index of the image to display
                                $imageIndex = ($i * 2 + $j);
                            @endphp

                            @if ($imageIndex < $totalImages) <!-- Ensure index is within range -->
                                <div class="col-6">
    ...
    <div id="categoryCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000"> <!-- Auto slide every 3 seconds -->
        <div class="carousel-inner">
            <!-- Carousel Item 1 -->
            <div class="carousel-item active">
                <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-4">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Laptops" class="img-fluid rounded-circle">
                            </div>
                            <h5>Laptops</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Mobiles" class="img-fluid rounded-circle">
                            </div>
                            <h5>Mobiles</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Accessories" class="img-fluid rounded-circle">
                            </div>
                            <h5>Accessories</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Televisions" class="img-fluid rounded-circle">
                            </div>
                            <h5>Televisions</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Furniture" class="img-fluid rounded-circle">
                            </div>
                            <h5>Furniture</h5>
                        </div>
                    </div>
            ...
            <div class="carousel-item">
                <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-4">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Footwear" class="img-fluid rounded-circle">
                            </div>
                            <h5>Footwear</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Books" class="img-fluid rounded-circle">
                            </div>
                            <h5>Books</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Sports" class="img-fluid rounded-circle">
                            </div>
                            <h5>Sports</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Toys" class="img-fluid rounded-circle">
                            </div>
                            <h5>Toys</h5>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="icon-container">
                                <img src="https://via.placeholder.com/100" alt="Groceries" class="img-fluid rounded-circle">
                            </div>
                            <h5>Groceries</h5>
                        </div>
                    </div>
        ...
        <!-- Optional: Add carousel indicators (dots) -->
